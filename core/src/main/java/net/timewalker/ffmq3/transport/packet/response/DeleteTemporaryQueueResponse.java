 ...
 */
public final class DeleteTemporaryQueueResponse extends AbstractResponsePacket 
{
    /* (non-Javadoc)
	...
	public byte getType()
    {
        return PacketType.R_DELETE_TEMP_QUEUE;
    }
    
    /**
     * Constructor
     */
    public DeleteTemporaryQueueResponse()
    {
        super();
    }
}
