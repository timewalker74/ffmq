 ...
 * MultiplyOperator
 */
public class MultiplyOperator extends AbstractArithmeticBinaryOperator
{
    /**
     * Constructor
     */
    public MultiplyOperator( SelectorNode leftOperand , SelectorNode rightOperand ) throws InvalidSelectorException
    {
    ...
    public Object evaluate(Message message) throws JMSException
    {
        ...
        return ArithmeticUtils.multiply(leftValue, rightValue);
    }
