 ...
 * DivideOperator
 */
public final class DivideOperator extends AbstractArithmeticBinaryOperator
{
    /**
     * Constructor
     */
    public DivideOperator( SelectorNode leftOperand , SelectorNode rightOperand ) throws InvalidSelectorException
    {
    ...
    public Object evaluate(Message message) throws JMSException
    {
        ...
        return ArithmeticUtils.divide(leftValue, rightValue);
    }
