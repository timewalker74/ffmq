...
import net.timewalker.ffmq4.common.message.selector.expression.SelectorNodeType;
import net.timewalker.ffmq4.common.message.selector.expression.utils.ArithmeticUtils;

/**
 * GreaterThanOperator
 */
public final class GreaterThanOperator extends AbstractNumericComparisonOperator
{
    /**
     * Constructor
     */
    public GreaterThanOperator( SelectorNode leftOperand , SelectorNode rightOperand ) throws InvalidSelectorException
    {
	...
	public Object evaluate(Message message) throws JMSException
    {
        ...
        return ArithmeticUtils.greaterThan((Number)leftValue, (Number)rightValue);
    }
