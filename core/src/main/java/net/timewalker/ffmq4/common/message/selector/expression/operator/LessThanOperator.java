...
public class LessThanOperator extends AbstractNumericComparisonOperator
{
     ...
     * Constructor
     */
    public LessThanOperator( SelectorNode leftOperand , SelectorNode rightOperand ) throws InvalidSelectorException
    {
	...
	public Object evaluate(Message message) throws JMSException
    {
        ...
        return ArithmeticUtils.lessThan((Number)leftValue, (Number)rightValue);
    }
