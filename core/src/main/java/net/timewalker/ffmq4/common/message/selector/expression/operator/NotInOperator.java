...
public class NotInOperator extends InOperator
{
     ...
     * Constructor
     */
    public NotInOperator( SelectorNode leftOperand , SelectorNode rightOperand ) throws InvalidSelectorException
    {
    ...
    /*
     * (non-Javadoc)
     * @see net.timewalker.ffmq4.common.message.selector.expression.InOperator#evaluate(javax.jms.Message)
     */
    @Override
