...
public class LessThanOrEqualsOperator extends AbstractNumericComparisonOperator
{
     ...
     * Constructor
     */
    public LessThanOrEqualsOperator( SelectorNode leftOperand , SelectorNode rightOperand ) throws InvalidSelectorException
    {
	...
	public Object evaluate(Message message) throws JMSException
    {
        ...
        return ArithmeticUtils.lessThanOrEquals((Number)leftValue, (Number)rightValue);
    }
