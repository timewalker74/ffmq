...
public final class SubstractOperator extends AbstractArithmeticBinaryOperator
{
     ...
     * Constructor
     */
    public SubstractOperator( SelectorNode leftOperand , SelectorNode rightOperand ) throws InvalidSelectorException
    {
	...
	public Object evaluate(Message message) throws JMSException
    {
        ...
        return ArithmeticUtils.substract(leftValue, rightValue);
    }
