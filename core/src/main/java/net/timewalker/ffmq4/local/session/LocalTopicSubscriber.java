...
/**
 * <p>Implementation of a local JMS {@link TopicSubscriber}</p>
 */
public class LocalTopicSubscriber extends LocalMessageConsumer implements TopicSubscriber
{
     ...
     * Constructor
     */
    public LocalTopicSubscriber(FFMQEngine engine, LocalSession session, Destination destination, String messageSelector, boolean noLocal, IntegerID consumerId, String subscriberId) throws JMSException
    {
